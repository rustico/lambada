...
To install Quick Python Lambda Wrapper, run this command in your terminal:
...
The sources for Quick Python Lambda Wrapper can be downloaded from the `Github repo`_.
